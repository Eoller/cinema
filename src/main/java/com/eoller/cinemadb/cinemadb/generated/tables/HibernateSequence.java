...
import com.eoller.cinemadb.cinemadb.generated.tables.records.HibernateSequenceRecord;
...
public class HibernateSequence extends TableImpl<HibernateSequenceRecord> {
    ...
    private static final long serialVersionUID = -487214744;

    /**
     * The reference instance of <code>cinemaDBtest.hibernate_sequence</code>
     */
    ...
    /**
     * The column <code>cinemaDBtest.hibernate_sequence.next_val</code>.
     */
    public final TableField<HibernateSequenceRecord, Long> NEXT_VAL = createField("next_val", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * Create a <code>cinemaDBtest.hibernate_sequence</code> table reference
     */
    ...
    /**
     * Create an aliased <code>cinemaDBtest.hibernate_sequence</code> table reference
     */
