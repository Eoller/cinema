...
public class MovieShowRecord extends UpdatableRecordImpl<MovieShowRecord> implements Record5<Long, Date, Time, Long, Long> {

    private static final long serialVersionUID = 1508320695;
     ...
     */
    @Override
    public Row5<Long, Date, Time, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row5<Long, Date, Time, Long, Long> valuesRow() {
     ...
     */
    @Override
    public MovieShowRecord values(Long value1, Date value2, Time value3, Long value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MovieShowRecord(Long id, Date showDate, Time showTime, Long cinemaHallId, Long movieId) {
        super(MovieShow.MOVIE_SHOW);
