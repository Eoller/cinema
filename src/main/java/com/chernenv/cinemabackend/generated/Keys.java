...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<MovieRecord, GenreRecord> GENRE_FK = Internal.createForeignKey(Keys.KEY_GENRE_PRIMARY, Movie.MOVIE, "genre_fk", Movie.MOVIE.GENRE_ID);
        public static final ForeignKey<MovieShowSeatRecord, MovieShowRecord> MOVIE_SHOW_FK = Internal.createForeignKey(Keys.KEY_MOVIE_SHOW_PRIMARY, MovieShowSeat.MOVIE_SHOW_SEAT, "Movie_show_fk", MovieShowSeat.MOVIE_SHOW_SEAT.MOVIE_SHOW_ID);
        public static final ForeignKey<MovieShowSeatRecord, SeatRecord> SEAT_ID_FK = Internal.createForeignKey(Keys.KEY_SEAT_PRIMARY, MovieShowSeat.MOVIE_SHOW_SEAT, "seat_id_fk", MovieShowSeat.MOVIE_SHOW_SEAT.SEAT_ID);
        public static final ForeignKey<MovieTrailerRecord, MovieRecord> TRAILER_FK = Internal.createForeignKey(Keys.KEY_MOVIE_PRIMARY, MovieTrailer.MOVIE_TRAILER, "trailer_fk", MovieTrailer.MOVIE_TRAILER.ID);
        public static final ForeignKey<ReservationRecord, MovieShowSeatRecord> MV_SH_SEAT_FK = Internal.createForeignKey(Keys.KEY_MOVIE_SHOW_SEAT_PRIMARY, Reservation.RESERVATION, "mv_sh_seat_fk", Reservation.RESERVATION.MOVIE_SHW_SEAT_ID);
    }
}
